...
[Flow просмотра собыития](https://www.figma.com/design/doino9pjh44FfHcUBS8W2C/Mobile?node-id=107-4283&t=JZzI5QuOEfgHZvBb-1) 
...
```json
{
    ...
    "end_time": "2024-09-07T16:44:21",                                                              // optional, time. Пользователь может и не указывать
...
```json
{
  ...
  "start_time": "2024-09-07T15:44:21",                                                            // required, time
  "end_time": "2024-09-07T16:44:21",                                                              // optional, time
  "capacity": 10                                                                                  // required, integer. -1 для безлимитного количества участников
}
```
...
# Поучаствовать в событии **PUT** `/event/{id}/participate`
...
# Отписаться от события **DELETE** `/event/{id}/cancel-participation`
